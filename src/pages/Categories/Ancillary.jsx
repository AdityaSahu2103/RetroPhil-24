...
const Ancillary = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const q = query(collection(db, 'products'), where('category', '==', 'Ancillary'));
  ...
  return (
    <div className="category-page bg-slate-100 ">
      <div className='bg-red-400 flex justify-center align-middle py-4 mb-6 text-2xl font-bold text-white'>Ancillary Items</div>
