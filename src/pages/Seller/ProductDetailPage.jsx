...
const ProductDetailPage = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      const docRef = doc(db, 'sellerProducts', id);
  ...
  const handleAddToCart = (e, product) => {
    ...
    addToCart(product, () => {
      ...
      setTimeout(() => setShowNotification(false), 4000); // Hide notification after 4 seconds
    });
  };
        ...
        <div className="p-10 md:w-1/2 flex flex-col justify-between">
          ...
          <div>
            <div className="flex space-x-4 mb-6">
              ...
              <Link to={`/certificate/${product.certificateNumber}`} className="border border-gray-300 px-6 py-3 rounded hover:bg-gray-100">
